...
-- fsk
alter table funcion add constraint fk_funcion_sala foreign key (id_sala) references sala_cine(id_sala);
alter table funcion add constraint fk_funcion_pelicula foreign key (id_pelicula) references pelicula(id_pelicula);

--alter table butaca_por_funcion add constraint fk_butaca_funcion foreign key (id_funcion) references funcion(id_funcion);
--alter table butaca_por_funcion add constraint fk_butaca_cliente foreign key (id_cliente) references cliente(id_cliente);

alter table error add constraint fk_error_sala foreign key (id_sala) references sala_cine(id_sala);
alter table error add constraint fk_error_pelicula foreign key (id_pelicula) references pelicula(id_pelicula);
alter table error add constraint fk_error_funcion foreign key (id_funcion) references funcion(id_funcion);
alter table error add constraint fk_error_cliente foreign key (id_cliente) references cliente(id_cliente);
